...
public class League {
    ...
    public Team[] createTeams() {
        ...
        Player player1 = new Player("Gabriel Martinelli");
        Player player2 = new Player("Declan Rice");
        Player player3 = new Player("Aaron Ramsdale");
        Player[] thePlayers = {player1, player2, player3};

        Team team1 = new Team("Arsenal", thePlayers);

        // Create team2
        Team team2 = new Team();
        team2.setTeamName("Man City");
        team2.setPlayerArray(new Player[3]);
        team2.getPlayerArray()[0] = new Player("Kevin De Bruyne");
        team2.getPlayerArray()[1] = new Player("Rodri");
        team2.getPlayerArray()[2] = new Player("Erling Haaland");
