 ...
 */
package Chapter_15.soccer.play;

import Chapter_15.soccer.event.GameEvent;
import Chapter_15.soccer.event.Goal;
...
import Chapter_15.soccer.util.PlayerDatabase;
import Chapter_15.soccer.util.PlayerDatabaseException;
import Chapter_15.soccer.util.Settings;
...
public class League {
    ...
    public IDisplayDataItem[][] getLeagueDataGrid(Game[] theGames, Team[] theTeams) {
        ...
        for (int i = 0; i < theTeams.length; i++) {
            ...
            theGrid[rowNum][colNum + 1] = new DisplayString(String.valueOf(currHomeTeam.getPointsTotal()));
            theGrid[rowNum][colNum + 1] = new DisplayString(String.valueOf(currHomeTeam.getGoalsTotal()));
        }
        return theGrid;
    }
